        ...
        <div class="row">
            ...
            <section>
               ...
               <br> 
                ...
                <a href="menuOpciones.jsp"><input type="button" value="Socios" class="boton-login"></a>
                <br><br><br>
                <a href="menuOpcionesColecciones.jsp"><input type="button" value="Colecciones" class="boton-login"></a>
                <br><br><br>
                <a href="login?opcion=cerrarSesion"><input type="button" value="Cerrar sesión" class="boton-login"></a>
