    ...
    <body>
        ...
        <div class="row">
            ...
            <section>
                ...
                <h3>Menú de opciones para las Coleccione Microbianas de la Felacc </h3>
                <br>
                
                <!-- href indica hacia donde se va a redireccionar (mapear) y diferencia la accion a realizar -->
                
                <a href="colecciones?op=agregarc"><input type="button" value="Agregar Colecciones" class="boton-login"></a>
                <br><br><br>
                <a href="colecciones?op=mostrarc"><input type="button" value="Mostrar Colecciones" class="boton-login"></a>
                <br><br><br>
